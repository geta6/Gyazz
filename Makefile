...
compile:
	...
	cd public/javascripts; coffee -b -c gyazz_related.coffee
	cd public/javascripts; coffee -b -c gyazz_tag.coffee
	cd public/javascripts; coffee -b -c gyazz_notification.coffee
	cd public/javascripts; coffee -b -c gyazz.coffee
